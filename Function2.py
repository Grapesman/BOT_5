    ...
    def date_check(book):
        ...
        for i in range(2, len(a) + 1):
            if sheet['D' + str(i)].value is not None and sheet['C' + str(i)].value is not None and sheet[
                ...
                if list_date_state is None or (isinstance(list_date_state, str) and list_date_state.strip() == ''):
                    list_date_state = datetime.datetime.strptime("01.03.2026", "%d.%m.%Y")
    ...
    def make_check(book):
        ...
        for i in range(2, len(a) + 1):
            if sheet['D' + str(i)].value is not None and sheet['C' + str(i)].value is not None and sheet[
                ...
                if list_make_state is None or (isinstance(list_make_state, str) and list_make_state.strip() == ''):
                    list_make_state = datetime.datetime.strptime("01.10.2025", "%d.%m.%Y")
